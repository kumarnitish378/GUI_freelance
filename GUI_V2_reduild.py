    ...
    def Hashin_Criteria(Xt, Xc, Yt, Yc, S12):
        for i in range(0, No_of_Layers):
            ...
            if (Condition_Matrix >= 0):
                ...
                Failure_Value = (Sigma_22 / Yt)**2 + (Sigma_66 / S12)**2
                ...
                if (Failure_Value >= 1):
                    ...
                    c1 = (Sigma_22 / Yt) ** 2 + (Sigma_66 / S12) ** 2
                    c2 = 0
                    c3 = -1
                    R = np.roots([c1, c2, c3])
                    if (R[0] > R[1]):
                ...
                Failure_Value = ((Yc / (2 * S23)) ** 2 - 1) * (Sigma_22 / Yc) + (Sigma_22 / (4 * S23)) ** 2 + (
                        Sigma_66 / S12) ** 2
                # file.write("Failure value is : \n", Failure_Value)
